              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="ai-chatbot">AI Chatbot Only - $499</option>
                    <option value="3-page">3-Page Website - $999</option>
                    <option value="4-7-page">4-7 Page Website - $1,999</option>
                    <option value="7-12-page">7-12 Page Website - $3,999</option>
